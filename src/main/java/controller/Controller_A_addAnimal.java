...
public class Controller_A_addAnimal  implements EventHandler<ActionEvent> {
    private Stage stage;
    private Model model;
    ...
    public Controller_A_addAnimal(Model model, Stage stage) throws SQLException {
        this.model = model;
        this.stage = stage;
    ...
    public void handle(ActionEvent actionEvent) {
        try {
            if(actionEvent.getSource() == addowner) {
                stage.setScene(null);
                new Controller_A_addOwner(model, stage);
            }
